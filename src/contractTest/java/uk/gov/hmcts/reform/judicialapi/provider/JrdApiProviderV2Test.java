...
public class JrdApiProviderV2Test {
  ...
  /*  @State({"return judicial user profiles"})
    ...
    private Page<UserProfile> getPageUserProfiles() {
        ...
        locationMappings1.setEpimmsId("2");
        locationMappings1.setJudicialBaseLocationId("2");
        locationMappings1.setServiceCode("service code1");
        ...
        authorisation.setJurisdiction("IA");
        ...
        userProfile.setKnownAs("abc");
        userProfile.setSurname("abc");
        userProfile.setFullName("abc");
        userProfile.setPostNominals("abc");
        userProfile.setActiveFlag(Boolean.TRUE);
        userProfile.setInitials("initials");
        userProfile.setTitle("title");
        userProfile.setRetirementDate(convertToLocalDate("2023-08-01"));
