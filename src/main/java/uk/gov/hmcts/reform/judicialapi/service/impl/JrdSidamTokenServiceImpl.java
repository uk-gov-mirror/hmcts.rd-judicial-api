...
import uk.gov.hmcts.reform.judicialapi.configuration.TokenConfigProperties;
import uk.gov.hmcts.reform.judicialapi.feign.IdamClient;
import uk.gov.hmcts.reform.judicialapi.response.OpenIdAccessTokenResponse;
...
public class JrdSidamTokenServiceImpl implements JrdSidamTokenService {
    ...
    public Set<IdamClient.User> getIdamElasticFeed() {
        Map<String, String> formParams = new HashMap<>();
    ...
    private String elasticSearchQuery() {
        LocalDateTime maxSchedulerEndTime = null;
        return maxSchedulerEndTime == null ? String.format(searchQuery,1) : String.format(searchQuery,
