...
ALTER TABLE public.judicial_office_appointment ADD CONSTRAINT elinks_Id_fk1 FOREIGN KEY (elinks_Id)
REFERENCES public.judicial_user_profile (elinks_Id);

ALTER TABLE public.judicial_office_appointment ADD CONSTRAINT role_id_fk1 FOREIGN KEY (role_id)
REFERENCES public.judicial_role_type (role_id);

ALTER TABLE public.judicial_office_appointment ADD CONSTRAINT contract_type_Id_fk1 FOREIGN KEY (contract_type_Id)
REFERENCES public.contract_type (contract_type_Id);

ALTER TABLE public.judicial_office_appointment ADD CONSTRAINT base_location_Id_fk1 FOREIGN KEY (base_location_Id)
REFERENCES public.base_location_type (base_location_Id);

ALTER TABLE public.judicial_office_appointment ADD CONSTRAINT region_Id_fk1 FOREIGN KEY (region_Id)
REFERENCES public.region_type (region_Id);

ALTER TABLE public.judicial_office_authorisation ADD CONSTRAINT elinks_Id_fk2 FOREIGN KEY (elinks_Id)
REFERENCES public.judicial_user_profile (elinks_Id);

ALTER TABLE public.judicial_office_authorisation ADD CONSTRAINT authorisation_Id_fk1 FOREIGN KEY (authorisation_Id)
REFERENCES public.authorisation_type (authorisation_Id);