package uk.gov.hmcts.reform.judicialapi.util.constants;
...
public class SqlQueryConstant {
    ...
    public static final String INSERT_JUD_OFFICE_AUTHORISATION
    ...
    public static final String DELETE_TEST_USERS_PROFILE = "DELETE FROM judicial_user_profile WHERE "
            + "object_id IN ('1111122223333');";

    public static final String DELETE_TEST_USERS_APPOINTMENT = "DELETE FROM judicial_office_appointment WHERE "
            + "object_id IN ('1111122223333');";

    public static final String DELETE_TEST_USERS_AUTHORISATION = "DELETE FROM judicial_office_authorisation WHERE "
            + "object_id IN ('1111122223333');";
}
